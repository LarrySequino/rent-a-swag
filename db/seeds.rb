...
Shirt.create size: "L", color: "Green", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "L", color: "Red", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "L", color: "Blue", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "L", color: "Pink", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "L", color: "Orange", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Green", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Red", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Blue", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Pink", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Orange", brand: "American Apparel", price: 20, organic: true
Shirt.create size: "XL", color: "Blue", brand: "Gucci", price: 65, organic: false
Shirt.create size: "S", color: "Green", brand: "Old Navy", price: 15, organic: false
Shirt.create size: "M", color: "Red", brand: "Old Navy", price: 25, organic: true
